...
{strip}
    "{$movie.title}";"{$movie.description}";"{$movie.uploadOfMovie}";"{$movie.urlOfYoutube}";"{$movie.poster}";"{$movie.widthOfMovie}";"{$movie.heightOfMovie}";"{$item.workflowState|muvideoObjectState:false|lower}"
