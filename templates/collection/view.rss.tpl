...
{foreach item='collection' from=$items}
    <item>
        ...
        <link>{modurl modname='MUVideo' type=$lct func='display' id=$collection.id fqurl='1'}</link>
        <guid>{modurl modname='MUVideo' type=$lct func='display' id=$collection.id fqurl='1'}</guid>
