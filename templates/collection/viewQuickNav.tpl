...
<form action="{$modvars.ZConfig.entrypoint|default:'index.php'}" method="get" id="mUVideoCollectionQuickNavForm" class="muvideo-quicknav">
    <fieldset>
        ...
        {/if}
        <input type="submit" name="updateview" id="muvideo_collectionquicknav_updateview" value="{gt text='OK'}" />
    </fieldset>
</form>
...
/* <![CDATA[ */
    document.observe('dom:loaded', function() {
        ...
        {{if isset($searchFilter) && $searchFilter eq false}}
            ...
            $('muvideo_collectionquicknav_updateview').addClassName('z-hide');
        {{/if}}
    });
/* ]]> */
</script>
