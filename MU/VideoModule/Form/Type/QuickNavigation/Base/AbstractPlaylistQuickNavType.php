...
/**
 * Playlist quick navigation form type base class.
 */
abstract class AbstractPlaylistQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * PlaylistQuickNavType constructor.
     *
    ...
    * @param EntityDisplayHelper $entityDisplayHelper EntityDisplayHelper service instance
    ...
    {
        $listEntries = $this->listHelper->getEntries('playlist', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'muvideomodule_playlistquicknav';
    }
}
