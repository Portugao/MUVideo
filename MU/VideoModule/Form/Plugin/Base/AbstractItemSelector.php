...
namespace MU\VideoModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if (!$permissionApi->hasPermission('MUVideoModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['collection', 'movie', 'playlist'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUVideoModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUVideoModule_objecttype', 'collection');
