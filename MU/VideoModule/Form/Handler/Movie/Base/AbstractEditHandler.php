...
use MU\VideoModule\Form\Type\MovieType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    {
        return $this->formFactory->create(MovieType::class, $this->entityRef, $this->getFormOptions());
    }
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUVideoModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'movie', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
