...
abstract class AbstractCollectionRepository extends EntityRepository
{
    ...
    public function truncateTable(LoggerInterface $logger)
    {
        ...
        $qb->delete('MU\VideoModule\Entity\CollectionEntity', 'tbl');
        $query = $qb->getQuery();
    
        $query->execute();
    
        $logArgs = ['app' => 'MUVideoModule', 'entity' => 'collection'];
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApi $currentUserApi)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MU\VideoModule\Entity\CollectionEntity', 'tbl')
        ...
        $logArgs = ['app' => 'MUVideoModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'collections', 'userid' => $userId];
    ...
    protected function getCountQuery($where = '', $useJoins = false)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('MU\VideoModule\Entity\CollectionEntity', 'tbl');
