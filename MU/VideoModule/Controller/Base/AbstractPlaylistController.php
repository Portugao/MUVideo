...
/**
 * Playlist controller base class.
 */
abstract class AbstractPlaylistController extends AbstractController
{
    ...
    protected function indexInternal(Request $request, $isAdmin = false)
    {
        ...
        return $this->redirectToRoute('muvideomodule_playlist_' . $templateParameters['routeArea'] . 'view');
    }
    /**
    ...
    protected function viewInternal(Request $request, $sort, $sortdir, $pos, $num, $isAdmin = false)
    {
        ...
        $sortableColumns = new SortableColumns($this->get('router'), 'muvideomodule_playlist_' . ($isAdmin ? 'admin' : '') . 'view', 'sort', 'sortdir');
    ...
    protected function editInternal(Request $request, $isAdmin = false)
    {
        ...
        $formHandler = $this->get('mu_video_module.form.handler.playlist');
    ...
    {
        return $this->deleteInternal($request, $playlist, true);
    }
    ...
    {
        return $this->deleteInternal($request, $playlist, false);
    }
    
    /**
     * This method includes the common implementation code for adminDelete() and delete().
     */
    protected function deleteInternal(Request $request, PlaylistEntity $playlist, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        ...
        $actions = $workflowHelper->getActionsForObject($playlist);
        ...
        $redirectRoute = 'muvideomodule_playlist_' . ($isAdmin ? 'admin' : '') . 'view';
        ...
        if (!$deleteAllowed) {
            $this->addFlash('error', $this->__('Error! It is not allowed to delete this playlist.'));
        ...
        if ($form->handleRequest($request)->isValid()) {
            if ($form->get('delete')->isClicked()) {
                ...
                $validationErrors = $hookHelper->callValidationHooks($playlist, UiHooksCategory::TYPE_VALIDATE_DELETE);
    ...
    {
        return $this->displayInternal($request, $playlist, true);
    }
    ...
    {
        return $this->displayInternal($request, $playlist, false);
    }
    
    /**
     * This method includes the common implementation code for adminDisplay() and display().
     */
    protected function displayInternal(Request $request, PlaylistEntity $playlist, $isAdmin = false)
    {
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        $permLevel = $isAdmin ? ACCESS_ADMIN : ACCESS_READ;
    ...
    protected function handleSelectedEntriesActionInternal(Request $request, $isAdmin = false)
    {
        ...
        foreach ($items as $itemId) {
            ...
            if ($action == 'delete') {
                $this->addFlash('status', $this->__('Done! Item deleted.'));
                $logger->notice('{app}: User {user} deleted the {entity} with id {id}.', ['app' => 'MUVideoModule', 'user' => $userName, 'entity' => 'playlist', 'id' => $itemId]);
            } else {
        ...
        return $this->redirectToRoute('muvideomodule_playlist_' . ($isAdmin ? 'admin' : '') . 'index');
    }
}
