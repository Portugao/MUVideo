...
abstract class AbstractConfigController extends AbstractController
{
    ...
    public function configAction(Request $request)
    {
        ...
        $form = $this->createForm(ConfigType::class, $this->get('mu_video_module.app_settings'));
        ...
        if ($form->handleRequest($request)->isValid()) {
            ...
            return $this->redirectToRoute('muvideomodule_config_config');
        }
        ...
        return $this->render('@MUVideoModule/Config/config.html.twig', $templateParameters);
    }
}
