 ...
 */
class MovieController extends AbstractMovieController
{
    /**
     * @inheritDoc
     *
    ...
    {
        return parent::adminDisplayAction($request, $movie);
    }
    ...
    {
        return parent::displayAction($request, $movie);
    }
    /**
     * @inheritDoc
     *
     * @Route("/admin/movie/edit/{id}.{_format}",
     ...
     * @inheritDoc
     *
     * @Route("/admin/movie/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
    ...
    {
        return parent::adminDeleteAction($request, $movie);
    }
    
    /**
     * @inheritDoc
     *
     * @Route("/movie/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
    ...
    {
        return parent::deleteAction($request, $movie);
    }
     ...
     *
     * @Route("/admin/movies/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     * @Theme("admin")
     *
     ...
     * Multiple items may have their state changed or be deleted.
     *
     * @Route("/movies/handleSelectedEntries",
     *        methods = {"POST"}
     * )
     *
     * @param Request $request Current request instance
