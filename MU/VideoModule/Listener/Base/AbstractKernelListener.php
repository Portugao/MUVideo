...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from video app';
     *     $event->getRequest()->attributes->set('MUVideoModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUVideoModule_test');`
     *     now `$testMessage` should be: `'Hello from video app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('video App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
