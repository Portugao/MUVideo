...
namespace MU\VideoModule\NewsletterPlugin;
...
class ItemListPlugin extends Newsletter_AbstractPlugin implements ContainerAwareInterface
{
    ...
    {
        return $this->container->get('translator.default')->__('Latest MUVideoModule items');
    }
    ...
    {
        return $this->container->get('translator.default')->__('List of collections and other MUVideoModule items');
    }
    ...
    {
        return $this->container->get('translator.default')->__('This plugin shows a list of collections and other items of the MUVideoModule module.');
    }
    ...
    public function getParameters()
    {
        ...
        if ($this->pluginAvailable()) {
            $objectTypes['collection'] = ['name' => $translator->__('Collections')];
            $objectTypes['movie'] = ['name' => $translator->__('Movies')];
            $objectTypes['playlist'] = ['name' => $translator->__('Playlists')];
        }
    ...
    protected function selectPluginData(array $args = [], $filterAfterDate = null)
    {
        ...
        $hasDisplayPage = in_array($objectType, ['collection', 'movie', 'playlist']);
        ...
        foreach ($entities as $k => $item) {
            ...
            if ($hasDisplayPage) {
                ...
                $items[$k]['nl_url_title'] = $router->generate('muvideomodule_' . strtolower($objectType) . '_display', $urlArgs, true);
            } else {
