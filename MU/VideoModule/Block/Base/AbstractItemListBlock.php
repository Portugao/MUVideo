...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('MUVideoModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('mu_video_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('MUVideoModule items');
        }
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('mu_video_module.category_helper'),
            'feature_activation_helper' => $this->get('mu_video_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@MUVideoModule/Block/itemlist_modify.html.twig';
    }
