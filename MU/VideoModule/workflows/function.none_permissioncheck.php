 ...
 */
function MUVideoModule_workflow_none_permissioncheck($obj, $permLevel, $currentUser, $actionId)
{
    // perform the permission check
    $result = SecurityUtil::checkPermission('MUVideoModule:' . ucfirst($obj->get_objectType()) . ':', $obj->getKey() . '::', $permLevel, $currentUser);
 ...
 */
function MUVideoModule_workflow_none_gettextstrings()
{
