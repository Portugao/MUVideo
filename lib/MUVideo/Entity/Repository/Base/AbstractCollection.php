 ...
 */
abstract class MUVideo_Entity_Repository_Base_AbstractCollection extends EntityRepository
{
    /**
    ...
    public function updateCreator($userId, $newUserId)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->update('MUVideo_Entity_Collection', 'tbl')
    ...
    public function addCommonViewFilters(QueryBuilder $qb)
    {
        ...
        foreach ($parameters as $k => $v) {
            if ($k == 'catId') {
                 ...
                 */
                $qb = ModUtil::apiFunc('MUVideo', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => 'collection', 'catids' => $v));
    ...
    protected function getCountQuery($where = '', $useJoins = true)
    {
        ...
        $qb = $this->getEntityManager()->createQueryBuilder();
        $qb->select($selection)
           ->from('MUVideo_Entity_Collection', 'tbl');
    ...
    {
        $selection = ', tblMovie, tblPlaylists';
    ...
    protected function addJoinsToFrom(QueryBuilder $qb)
    {
        ...
        $qb->leftJoin('tbl.playlists', 'tblPlaylists');
