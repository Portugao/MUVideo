...
class MUVideo_Entity_Repository_Base_Movie extends EntityRepository
{
     ...
     *
     * @return array|MUVideo_Entity_Movie retrieved data array or MUVideo_Entity_Movie instance
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false).
     *
     * @return ArrayCollection collection containing retrieved MUVideo_Entity_Movie instances
     *
     * @throws InvalidArgumentException Thrown if invalid parameters are received
     */
