 ...
 */
    ...
    abstract class MUVideo_Entity_Base_Movie extends Zikula_EntityAccess
    {
        ...
        {
            if ($uploadOfMovie != $this->uploadOfMovie) {
        ...
        {
            if ($uploadOfMovieFullPath != $this->uploadOfMovieFullPath) {
        ...
        {
            if ($uploadOfMovieFullPathUrl != $this->uploadOfMovieFullPathUrl) {
        ...
        {
            if ($uploadOfMovieMeta != $this->uploadOfMovieMeta) {
        ...
        {
            if ($urlOfYoutube != $this->urlOfYoutube) {
        ...
        {
            if ($posterFullPath != $this->posterFullPath) {
        ...
        {
            if ($posterFullPathUrl != $this->posterFullPathUrl) {
