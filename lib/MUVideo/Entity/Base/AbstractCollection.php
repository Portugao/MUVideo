 ...
 * @abstract
 */
abstract class MUVideo_Entity_Base_AbstractCollection extends Zikula_EntityAccess
{
    /**
     ...
     *
     * @ORM\OneToMany(targetEntity="MUVideo_Entity_Movie", mappedBy="collection", cascade={"persist"})
     ...
     *
     * @ORM\OneToMany(targetEntity="MUVideo_Entity_Playlist", mappedBy="collection", cascade={"persist"})
