 ...
 * @abstract
 */
abstract class MUVideo_Entity_Base_AbstractPlaylist extends Zikula_EntityAccess
{
    /**
     ...
     *
     * @ORM\ManyToOne(targetEntity="MUVideo_Entity_Collection", inversedBy="playlists", cascade={"persist"})
