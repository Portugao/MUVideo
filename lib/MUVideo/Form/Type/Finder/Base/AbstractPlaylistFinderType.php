...
/**
 * Playlist finder form type base class.
 */
abstract class AbstractPlaylistFinderType extends AbstractType
{
    use TranslatorTrait;

    /**
     * PlaylistFinderType constructor.
     *
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteas', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Link to the playlist') => 1,
                $this->__('ID of playlist') => 2
            ],
        ...
        $builder
            ->add('sort', 'Symfony\Component\Form\Extension\Core\Type\ChoiceType', [
                ...
                'choices' => [
                    ...
                    $this->__('Url of youtube playlist') => 'urlOfYoutubePlaylist',
