 ...
 */
abstract class MUVideo_Form_Handler_Playlist_Base_AbstractEdit extends MUVideo_Form_Handler_Common_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        if ($this->mode == 'create') {
            ...
            if (!$modelHelper->canBeCreated($this->objectType)) {
                LogUtil::registerError($this->__('Sorry, but you can not create the playlist yet as other items are required which must be created before!'));
