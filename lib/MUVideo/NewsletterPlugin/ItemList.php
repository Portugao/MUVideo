 ...
 */
class MUVideo_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest MUVideo items');
    }
    ...
    {
        return $this->__('List of collections and other MUVideo items');
    }
    ...
    {
        return $this->__('This plugin shows a list of collections and other items of the MUVideo module.');
    }
    ...
    public function getParameters()
    {
        ...
        if ($this->pluginAvailable() && ModUtil::loadApi($this->modname)) {
            ...
            $objectTypes['playlist'] = array('name' => $this->__('Playlists'));
        }
