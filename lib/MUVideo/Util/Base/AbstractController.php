 ...
 */
abstract class MUVideo_Util_Base_AbstractController extends Zikula_AbstractBase
{
    /**
    ...
    public function getFileBaseFolder($objectType, $fieldName, $ignoreCreate = false)
    {
        ...
        $basePath = FileUtil::getDataDirectory() . '/MUVideo/';
    ...
    protected function checkAndCreateUploadFolder($objectType, $fieldName, $allowedExtensions = '')
    {
        ...
        $htaccessFileTemplate = 'modules/MUVideo/docs/htaccessTemplate';
