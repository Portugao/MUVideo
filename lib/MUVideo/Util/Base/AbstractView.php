 ...
 */
abstract class MUVideo_Util_Base_AbstractView extends Zikula_AbstractBase
{
    /**
    ...
    {
        $extensions = array();
        $hasAdminAccess = SecurityUtil::checkPermission('MUVideo:' . ucfirst($type) . ':', '::', ACCESS_ADMIN);
        if ($func == 'view') {
            if ($hasAdminAccess) {
                $extensions = array('csv', 'rss', 'atom', 'json', 'kml');
            } else {
