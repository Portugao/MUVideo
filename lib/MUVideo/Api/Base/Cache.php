 ...
 */
class MUVideo_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $cacheIds[] = 'MUVideo/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'MUVideo/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)
