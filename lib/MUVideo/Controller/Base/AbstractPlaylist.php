 ...
 */
abstract class MUVideo_Controller_Base_AbstractPlaylist extends Zikula_AbstractController
{
    /**
     * Post initialise.
     *
    ...
    public function main()
    {
        ...
        $objectType = 'playlist';
        $utilArgs = array('controller' => 'playlist', 'action' => 'main');
        ...
        if ($legacyControllerType == 'admin') {
            ...
            $redirectUrl = ModUtil::url($this->name, 'playlist', 'view', array('lct' => $legacyControllerType));
        ...
        $this->view->setCacheId('playlist_main');
        
        // return main template
        return $this->view->fetch('playlist/main.tpl');
    }
    /**
    ...
    public function view()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        $utilArgs = array('controller' => 'playlist', 'action' => 'view');
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'playlist', 'view', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function edit()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        $utilArgs = array('controller' => 'playlist', 'action' => 'edit');
        ...
        $handlerClass = $this->name . '_Form_Handler_Playlist_Edit';
    ...
    public function delete()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        $utilArgs = array('controller' => 'playlist', 'action' => 'delete');
        ...
        if (!$deleteAllowed) {
            return LogUtil::registerError($this->__('Error! It is not allowed to delete this playlist.'));
        }
        ...
        if ($confirmation) {
            ...
            if ($validationHooksPassed) {
                ...
                // The playlist was deleted, so we clear all cached pages this item.
    ...
    public function display()
    {
        ...
        // parameter specifying which type of objects we are treating
        $objectType = 'playlist';
        $utilArgs = array('controller' => 'playlist', 'action' => 'display');
        $permLevel = $legacyControllerType == 'admin' ? ACCESS_ADMIN : ACCESS_READ;
        $this->throwForbiddenUnless(SecurityUtil::checkPermission($this->name . ':' . ucfirst($objectType) . ':', '::', $permLevel), LogUtil::getErrorMsgPermission());
        $entityClass = $this->name . '_Entity_' . ucfirst($objectType);
        $repository = $this->entityManager->getRepository($entityClass);
        ...
        $currentUrlObject = new Zikula_ModUrl($this->name, 'playlist', 'display', ZLanguage::getLanguageCode(), $currentUrlArgs);
    ...
    public function adminHandleSelectedEntries()
    {
        ...
        foreach ($items as $itemid) {
            ...
            if ($action != 'delete') {
                ...
                $url = new Zikula_ModUrl($this->name, 'playlist', 'display', ZLanguage::getLanguageCode(), $urlArgs);
            }
        ...
        $redirectUrl = ModUtil::url($this->name, 'admin', 'main', array('ot' => 'playlist'));
